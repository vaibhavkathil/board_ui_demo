...
var PodApi = {
    savePod: function(pod){
        //saved pod data
    }

};

module.exports = PodApi;
        ...
        React.createElement("nav", {className: "navbar navbar-default"}, 
          React.createElement("div", {className: "container-fluid"}, 
              ...
              React.createElement("ul", {className: "nav navbar-nav"}, 
                React.createElement("li", null, React.createElement("a", {href: "/"}, "Visualization")), 
                React.createElement("li", null, React.createElement("a", {href: "/#addDashboard"}, "Add Dashboard"))
              )
          )
        )
		);
...
var DashboardComponent = React.createClass({displayName: "DashboardComponent",
	...
	render: function () {
		return (
			...
			React.createElement(DashbaordConfig, null), 
			React.createElement(Pod, {userId: "dummy"})
			)
		); 
	}
...
},{"./dashboardConfigComponent":163,"./podComponent":164,"react":157}],163:[function(require,module,exports){
"use strict";

var React = require('react');


var DashbaordConfig = React.createClass({displayName: "DashbaordConfig",

	render: function () {
		return (
			React.createElement("div", {className: "panel panel-default"}, 
			React.createElement("div", {className: "panel-heading"}, "Dashboard Configuration")
			)
		); 
	}
...
module.exports = DashbaordConfig;
...
var Pod = React.createClass({displayName: "Pod",
	...
	render: function () {
		return (
			React.createElement("div", {className: "panel panel-default"}, 
			React.createElement("div", {className: "panel-heading"}, "Pod Configuration"), 
				React.createElement(PodInitForm, {
...
},{"../../../api/chartApi":158,"../../../api/podApi":159,"./podInitForm":165,"react":157}],165:[function(require,module,exports){
"use strict";

var React = require('react');
var Input = require('../../common/textInput');

var PodInitForm = React.createClass({displayName: "PodInitForm",
	propTypes: {
	...
	render: function() {
		return (
			React.createElement("form", null, 
				React.createElement("h1", null, "Configure Pod"), 
...
},{"../../common/textInput":161,"react":157}],166:[function(require,module,exports){
"use strict";
...
},{"./components/common/header":160,"./components/dashboard/add/dashboardComponent":162,"./components/homePage":166,"jquery":1,"react":157}]},{},[167]);
